...
//🚀🚀🚀 ⬇️ 📝 Explanation ⬇️ 📝 🚀🚀🚀: 
/** The nested function can access the variable internal because it is inside the function 
 */
...
function lowerCaseNames(zooAnimals) {
  return zooAnimals.map(function (lowerCase) {
...
function lowPopulationAnimals(zooAnimals) {
  return zooAnimals.filter(lowPop => lowPop.population < 5);
}
...
function USApop(zooAnimals) {
  let cutBack = function (accumulator, animal) {
    return accumulator + animal.population;
  }
  return zooAnimals.reduce(cutBack, 0);
}
